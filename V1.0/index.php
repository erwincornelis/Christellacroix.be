...
<head> 
	<base href="http://localhost/00_Websites/Christellacroix.be/v1.0/">
	...
	* {
		...
		#navigation #navigation_border {
			...
			#navigation #navigation_border ul {
				...
				#navigation #navigation_border ul li a.nav-active {
					...
					#navigation #navigation_border ul li a .dummy {
						background-color: #3A3A3A;
						height: 58px;
						color: black;
						position: absolute;
					...
					#navigation #navigation_border ul li a .picture-active {
					...
					#navigation #navigation_border ul li a .picture-non-active {
						background-color: #72BAFF;
						height: 110px;
						position: absolute;
						top: -15px;
	...
	$(document).ready(function() {
		var originalNavImgTopLoc = $('#navigation #navigation_border ul li a.nav-non-active .picture-non-active').position();
		$('#navigation #navigation_border ul li a.nav-non-active')
			.mouseover(function() {
				$(this).stop().animate({paddingBottom: '0px', paddingTop: '20px', color: '#167CD1'}, {duration: 400}); // , easing: 'easeOutBounce'
				$(this).children(".picture-non-active").stop().animate({top: '-100px'}, {duration: 400}); // , easing: 'easeOutBounce'
			})
			.mouseout(function() {
				$(this).stop().animate({paddingBottom: '10px', paddingTop: '10px', color: '#FFFFFF'}, {duration: 400}); // , easing: 'easeOutBounce'
				$(this).children(".picture-non-active").stop().animate({top: originalNavImgTopLoc.top}, {duration: 400}); // , easing: 'easeOutBounce'
			});
		
		$('.praktijknav:not(.praktijknav-active)')
			.live('mouseover', function() {
				$(this).stop().animate({paddingLeft: '25px', backgroundColor: '#DDDDDD'}, {duration: 400}); // , easing: 'easeOutBounce' 
			})
			.live('mouseout', function() {
				$(this).stop().animate({paddingLeft: '5px', backgroundColor: '#FFFFFF'}, {duration: 400}); // , easing: 'easeOutBounce'
			});
		...
		jQuery(window).bind('hashchange', function(e) {
			...
			$.ajax({
				...
				beforeSend: function() {
					$('.praktijknav-active').stop().animate({paddingLeft: '5px', backgroundColor: '#FFFFFF'}, {duration: 400}); // , easing: 'easeOutBounce' //mouseout the active tabs
					...
					$('.praktijknav-active').stop().animate({paddingLeft: '25px', backgroundColor: '#DDDDDD'}, {duration: 400}); // , easing: 'easeOutBounce'
	...
	$(window).load(function() {
		...
		$('#praktijkNavigatie').css({opacity: 0.0}).animate({opacity: 1.0, top: '+=50px'}, {duration: 800}); // , easing: 'easeOutBounce'
	});
	</script>	
...
<div id="page">
	...
	<div id="navigation">
		<div id="navigation_border">
			<ul>
				<li>
					<a href="startpagina/" class="<?php (!isset($_GET['p']) || $_GET['p'] == 'startpagina') ? print("nav-active") : print("nav-non-active"); ?>">
						<div class="text">Startpagina</div>
						<div class="dummy"></div>
						<div class="<?php (!isset($_GET['p']) || $_GET['p'] == 'startpagina') ? print("picture-active") : print("picture-non-active"); ?>" style="background: #72BAFF url('images/.jpg') no-repeat 0 5px;"></div>
					</a>
				</li>
				<li>
					<a href="trainingen/" class="<?php (isset($_GET['p']) && $_GET['p'] == 'trainingen') ? print("nav-active") : print("nav-non-active"); ?>">
						<div class="text">Trainingen</div>
						<div class="dummy"></div>
						<div class="<?php (isset($_GET['p']) && $_GET['p'] == 'trainingen') ? print("picture-active") : print("picture-non-active"); ?>" style="background: #72BAFF url('images/.jpg') no-repeat 0 5px;"></div>
					</a>
				</li>
				<li>
					<a href="achtergrond/" class="<?php (isset($_GET['p']) && $_GET['p'] == 'achtergrond') ? print("nav-active") : print("nav-non-active"); ?>">
						<div class="text">Achtergrond</div>
						<div class="dummy"></div>
						<div class="<?php (isset($_GET['p']) && $_GET['p'] == 'achtergrond') ? print("picture-active") : print("picture-non-active"); ?>" style="background: #72BAFF url('images/.jpg') no-repeat 0 5px;"></div>
					</a>
				</li>
				<li>
					<a href="praktijk/" class="<?php (isset($_GET['p']) && $_GET['p'] == 'praktijk') ? print("nav-active") : print("nav-non-active"); ?>">
						<div class="text">Praktijk</div>
						<div class="dummy"></div>
						<div class="<?php (isset($_GET['p']) && $_GET['p'] == 'praktijk') ? print("picture-active") : print("picture-non-active"); ?>" style="background: #72BAFF url('images/praktijk.jpg') no-repeat 0 5px;"></div>
					</a>
				</li>
				<li>
					<a href="mediatraining/" class="<?php (isset($_GET['p']) && $_GET['p'] == 'mediatraining') ? print("nav-active") : print("nav-non-active"); ?>">
						<div class="text">Mediatraining</div>
						<div class="dummy"></div>
						<div class="<?php (isset($_GET['p']) && $_GET['p'] == 'mediatraining') ? print("picture-active") : print("picture-non-active"); ?>" style="background: #72BAFF url('images/mediatraining.jpg') no-repeat 0 5px;"></div>
					</a>
				</li>
				<li>
					<a href="presentatietraining/" class="<?php (isset($_GET['p']) && $_GET['p'] == 'presentatietraining') ? print("nav-active") : print("nav-non-active"); ?>">
						<div class="text">Presentatietraining</div>
						<div class="dummy"></div>
						<div class="<?php (isset($_GET['p']) && $_GET['p'] == 'presentatietraining') ? print("picture-active") : print("picture-non-active"); ?>" style="background: #72BAFF url('images/.jpg') no-repeat 0 5px;"></div>
					</a>
				</li>
				<li>
					<a href="goedgestemd/" class="<?php (isset($_GET['p']) && $_GET['p'] == 'goedgestemd') ? print("nav-active") : print("nav-non-active"); ?>">
						<div class="text">Goed gestemd</div>
						<div class="dummy"></div>
						<div class="<?php (isset($_GET['p']) && $_GET['p'] == 'goedgestemd') ? print("picture-active") : print("picture-non-active"); ?>" style="background: #72BAFF url('images/.jpg') no-repeat 0 5px;"></div>
					</a>
				</li>
				<li>
					<a href="linken/" class="<?php (isset($_GET['p']) && $_GET['p'] == 'linken') ? print("nav-active") : print("nav-non-active"); ?>">
						<div class="text">Linken</div>
						<div class="dummy"></div>
						<div class="<?php (isset($_GET['p']) && $_GET['p'] == 'linken') ? print("picture-active") : print("picture-non-active"); ?>" style="background: #72BAFF url('images/.jpg') no-repeat 0 5px;"></div>
					</a>
				</li>
				<li>
					<a href="contact/" class="<?php (isset($_GET['p']) && $_GET['p'] == 'contact') ? print("nav-active") : print("nav-non-active"); ?>">
						<div class="text">Contact</div>
						<div class="dummy"></div>
						<div class="<?php (isset($_GET['p']) && $_GET['p'] == 'contact') ? print("picture-active") : print("picture-non-active"); ?>" style="background: #72BAFF url('images/.jpg') no-repeat 0 5px;"></div>
					</a>
				</li>
			</ul>
			<div class="clear"></div>
