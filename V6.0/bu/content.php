...
switch ($_GET['p']) {
	...
	<div class="tabs">
		...
		<div id="workshops-aanbod">
			<h1>Aanbod</h1>
			<div class="aanbod-title">Workshop: eerste hulp bij stemproblemen</div>
			<p>
				Het is weer zover. Het schooljaar is bijna halverwege en mijn stem begint moe te klinken. Ik krijg niet alles meer zo luid gezegd , ik klink snel hees en soms doet mijn stem zelfs pijn.<br />
Nu is het het moment om er iets aan te doen.<br />
In een workshop van 2 avonden gaan we samen op weg om je stem helder te laten klinken en vooral met veel minder inspanning te praten.<br />
Zo halen we zonder problemen het einde van het schooljaar.
			</p>
			<table cellspacing="0" cellpadding="0">
				<tr>
					<td class="aanbod-table-title"><p>Inhoud</p></td>
					<td class="aanbod-table-data">
						<p>
							Wat is goed voor de stem en wat niet<br />
							Ademhaling<br />
							Open en vooraan spreken<br />
							Draagkracht<br />
							Aandacht voor individueel stemgebruik en individuele stemtips
						</p>
					</td>
				</tr>
				<tr>
					<td class="aanbod-table-title"><p>Voor wie</p></td>
					<td class="aanbod-table-data">Leerkrachten</td>
				</tr>
				<tr>
					<td class="aanbod-table-title"><p>Data</p></td>
					<td class="aanbod-table-data">
						<p>
							21 en 27 maart of 15 en 22 april
						</p>
					</td>
				</tr>
				<tr>
					<td class="aanbod-table-title"><p>Uur</p></td>
					<td class="aanbod-table-data"><p>19.00 - 21.00u</p></td>
				</tr>
				<tr>
					<td class="aanbod-table-title"><p>Materiaal</p></td>
					<td class="aanbod-table-data"><p>Goed Gestemd (incl in de prijs van de cursus)</p></td>
				</tr>
				<tr>
					<td class="aanbod-table-title"><p>Prijs</p></td>
					<td class="aanbod-table-data"><p>2 avonden incl boek<br />€ 95</p></td>
				</tr>
				<tr>
					<td class="aanbod-table-title"><p>Deelnemers</p></td>
					<td class="aanbod-table-data"><p>Minimum 5 maximum 9</p></td>
				</tr>
				<tr>
					<td class="aanbod-table-title"><p>Cursusadres</p></td>
					<td class="aanbod-table-data"><p>Veldekens 44<br />2600 Berchem</p></td>
				</tr>
				<tr>
					<td class="aanbod-table-title"><p>Contact</p></td>
					<td class="aanbod-table-data"><p>Christel Lacroix<br /><a href="http://www.christellacroix.be">www.christellacroix.be</a></p></td>
				</tr>
			</table>
			
			<div class="aanbod-title">Workshop : Goed Gestemd : train je stem</div>
			<p>
				Als je veel moet spreken vraag je heel veel van je stembanden.<br />
				Net zoals je gaat fitnessen om in vorm te blijven kun je je spreekgedrag ook trainen.<br />
				Door een paar eenvoudige technieken toe te passen kun je met meer kracht en dynamiek spreken zonder je stem te belasten.<br />
				Je leert je stem zo te gebruiken dat ze warm en vol klinkt en je je publiek blijft boeien.<br />
				In deze workshop nemen we de eerste stappen naar een goed en efficiënt stemgebruik en bekijken we hoe je je stem kan sparen.<br />
			</p>
			<table cellspacing="0" cellpadding="0">
				<tr>
					<td class="aanbod-table-title"><p>Voor wie</p></td>
					<td class="aanbod-table-data">Iedereen die veel moet spreken en graag met zijn stem bezig is</td>
				</tr>
				<tr>
					<td class="aanbod-table-title"><p>Data</p></td>
					<td class="aanbod-table-data">
						<p>16 mei en 23 mei</p>
					</td>
				</tr>
				<tr>
					<td class="aanbod-table-title"><p>Uur</p></td>
